...
struct EnemyShootingComponent
{
    ...
    static EnemyShootingComponent create(float interval = 1.5F, float speed = 300.0F, std::int32_t damage = 5,
                                         float lifetime = 3.0F);
};

inline EnemyShootingComponent EnemyShootingComponent::create(float interval, float speed, std::int32_t damage,
                                                             float lifetime)
{
