...
bool startReceiver(NetPipelines& net, std::uint16_t port, std::atomic<bool>& handshakeFlag)
{
    ...
    net.handler =
        std::make_unique<NetworkMessageHandler>(net.raw, net.parsed, net.levelInit, net.levelEvents, net.spawns,
                                                net.destroys, &handshakeFlag, &net.allReady, &net.countdownValue,
                                                &net.gameStartReceived, &net.joinDenied, &net.joinAccepted);
