...
ServerApp::ServerApp(std::uint16_t port, std::atomic<bool>& runningFlag)
    : playerInputSys_(250.0F, 500.0F, 2.0F, 10), movementSys_(),
      ...
      obstacleSpawnSys_(ObstacleSpawnConfig{},
                        {ObstacleVariant{toTypeId(EntityTypeId::ObstacleSmall), toTypeId(EntityTypeId::ObstacleTopSmall),
                                         "obstacle_mountain_small", "obstacle_mountain_small_top", 220.0F, 170.0F,
                                         220.0F, 108.0F, 62.0F, 0.0F},
                         ObstacleVariant{toTypeId(EntityTypeId::ObstacleMedium), toTypeId(EntityTypeId::ObstacleTopMedium),
                                         "obstacle_mountain_medium", "obstacle_mountain_medium_top", 280.0F, 210.0F,
                                         280.0F, 138.0F, 72.0F, 0.0F},
                         ObstacleVariant{toTypeId(EntityTypeId::ObstacleLarge), toTypeId(EntityTypeId::ObstacleTopLarge),
                                         "obstacle_mountain_large", "obstacle_mountain_large_top", 360.0F, 260.0F,
                                         360.0F, 171.0F, 89.0F, 0.0F}}),
